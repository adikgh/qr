<? include "../../config/core.php";
	...
	$product_all = db::query("select * from product where arh = 0");
	...
	$product = db::query("select * from product where arh = 0 order by ins_dt desc limit $page_start, $page_age");
									...
									<!-- <div class="uc_uil"> -->
										...
										<td class="td_other">
											<div class="uc_uin_other">
												<input type="tel" class="uc_uin_calc_q fr_price item_upd_pr" data-id="<?=$item_d['id']?>" value="<?=$item_d['price']?>" data-lenght="1" />
											</div>
										</td>
										<td class="td_other">
											<div class="uc_uin_other">
