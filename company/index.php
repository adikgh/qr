<? include "../config/core.php";
	...
	$product_all = db::query("select * from product where sale = 1 and arh = 0");
	...
	$product = db::query("select * from product where sale = 1 and arh = 0 order by id desc limit $page_start, $page_age");
